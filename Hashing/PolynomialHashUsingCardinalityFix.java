...
class PolynomialHashUsingCardinalityFix{
    ...
    PolynomialHashUsingCardinalityFix(int p, int x, int m){
        this.p=p;
        this.x=x;
        this.m=m;
    ...
    public static void main(String[] args){
        int p = 1_000_033;
        PolynomialHashUsingCardinalityFix hash=new PolynomialHashUsingCardinalityFix(p, 23, 100);
